...
def run_stack(SEED):
	...
	clfs = [
		SVC(C=1000000, kernel='rbf', degree=3, gamma=0.0000001, coef0=0.0, shrinking=True, probability=False, tol=0.001, cache_size=200, class_weight=None, verbose=False)
		]		
		...
		for C in CC:
			for g in gg:	
				...
				for train_index, test_index in Folds:
					...
					clf = SVC(C=10**C, kernel='rbf', degree=4, gamma=10**g, coef0=0.0, shrinking=True, probability=False, tol=0.001, cache_size=200, class_weight=None, verbose=False)
