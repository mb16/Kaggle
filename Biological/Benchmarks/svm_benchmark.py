...
def main():
    ...
    for train_index, test_index in bs:
        ...
        #if (True):	
            #for y in range(0, 6):
                svc = svm.SVC(probability=True, C=10**-8, cache_size=800, coef0=0.0, degree=3, kernel='rbf', shrinking=True, tol=0.001)
    ...
    csv_io.write_delimited_file("../Submissions/svm_med_benchmark.csv", med_values)	

    avg_values = ["%f" % x for x in avg_list]
    csv_io.write_delimited_file("../Submissions/svm_avg_benchmark.csv", avg_values)	
