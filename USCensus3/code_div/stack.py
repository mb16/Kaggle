...
def run_stack(SEED):
	...
	trainBase = csv_io.read_data("PreProcessData/training_PreProcess5_40.csv", skipFirstLine = False, split = "\t")
	test = csv_io.read_data("PreProcessData/test_PreProcess5_40.csv", skipFirstLine = False, split = "\t")
	...
	# I 
	clfs = [GradientBoostingRegressor(max_features=40, learn_rate=0.05, subsample=0.5, max_depth=6, n_estimators=3000, random_state=166, min_samples_leaf=1)
			]		
