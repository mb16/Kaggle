...
def PreProcessRun(dataSet):
	...
	print "Loading Data"
	data = csv_io.read_data("PreProcessData/" + dataSet + "_PreProcess2.csv", split="\t" ,skipFirstLine = False)
	...
	csv_io.write_delimited_file("PreProcessData/" + dataSet + "_PreProcess3.csv", data, delimiter="\t")
	
	if ( dataSet == "test" ): # do only once.
		shutil.copy2("PreProcessData/DataClassList2.csv", "PreProcessData/DataClassList3.csv")
		csv_io.write_delimited_file("PreProcessData/DataClassList3.csv", ["CenPop2010_Latitude"], filemode="a")
		csv_io.write_delimited_file("PreProcessData/DataClassList3.csv", ["CenPop2010_Longitude"], filemode="a")
