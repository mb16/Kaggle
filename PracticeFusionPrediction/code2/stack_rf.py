...
def run_stack(SEED):
	...
	n_estArr = [1,2,4,6,8,12,16] # good set 50,100,150
	learn_rArr =  [0.09, 0.05, 0.02] # good min_density
	...
	for n_est in n_estArr:
		for learn_r in learn_rArr:
			...
			clf = RandomForestClassifier(n_estimators=150, criterion='entropy', max_depth=n_est, min_samples_split=1, min_samples_leaf=1, min_density=learn_r, max_features='auto', bootstrap=True, compute_importances=False, oob_score=False, n_jobs=1, random_state=None, verbose=0)
