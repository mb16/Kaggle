...
def PreProcessRun(dataSet):
	...
	for item in data:
		...
		for index, val in enumerate(item):
			...
			if ( val == "" or val == "NA"):  # set NA to 0 and then step 3 trains to predict 0 values.
				rowNew.append(0.0)
				#rowNew.append(meanSum[index])  # don't replace unknowns and these will be done later with KNN and lat/long.
				#rowNew.append(val)
