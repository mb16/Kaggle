...
def PreProcess4():
	...
	shutil.copy2("PreProcessData/DataClassList3.csv", "PreProcessData/DataClassList5_Base.csv")	
	
	target = [x[0] for x in trainBase]
	train = [x[1:] for x in trainBase]
	
	DataClassList = csv_io.read_data("PreProcessData/DataClassList5_Base.csv", False)
	...
	csv_io.write_delimited_file("PreProcessData/training_PreProcess5_Base.csv", trainNew, delimiter="\t")		
	csv_io.write_delimited_file("PreProcessData/test_PreProcess5_Base.csv", testNew, delimiter="\t")
